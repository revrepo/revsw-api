  ...
  config: {
    ...
    validate: {
      query: {
        ...
        target_type: Joi.string().valid('user', 'account', 'domain', 'object', 'apikey', 'logshippingjob', 'app', 'sslcert', 'sslname', 'dnszone', 'dnsrecord', 'wafrule')
        ...
        activity_type: Joi.string().valid('login', 'add', 'modify', 'delete', 'publish', 'purge', 'init2fa', 'enable2fa',
          'disable2fa', 'resetpassword', 'signup', 'verify','verify_email').description('Activity type (\'login\', \'add\', \'modify\', \'delete\', \'publish\', \'purge\','+
