        ...
        payload: {
          ...
          rev_component_bp: Joi.object({
            ...
            custom_vcl: Joi.object({
              ...
              recv: Joi.string().trim().allow('').default('').max(40000),
              backend_response: Joi.string().trim().allow('').default('').max(40000),
              backend_error: Joi.string().trim().allow('').default('').max(40000),
              backend_fetch: Joi.string().trim().allow('').default('').max(40000),
              hit: Joi.string().trim().allow('').default('').max(40000),
              miss: Joi.string().trim().allow('').default('').max(40000),
              deliver: Joi.string().trim().allow('').default('').max(40000),
              pass: Joi.string().trim().allow('').default('').max(40000),
              pipe: Joi.string().trim().allow('').default('').max(40000),
              hash: Joi.string().trim().allow('').default('').max(40000),
              synth: Joi.string().trim().allow('').default('').max(40000)
            })
          }).required(),
