...
describe('Sanity check.', function () {
  ...
  describe('Stats resource.', function () {
    parallel('With long data,', function () {

      var getSpecDescription = function (queryData) {
        return 'should return bad request when trying get domain\'s stats ' +
          'with long `' + Object.keys(queryData).join(', ') + '` value(s)';
      };

      var getSpecLongDataCallback = function (queryData) {
      ...
      StatsDDHelper
        ...
        .forEach(function (queryParams) {
          ...
          var specCallback = getSpecLongDataCallback(queryParams);
          /** Running spec for each query params */
          it(specDescription, specCallback);
        });
    });

    parallel('GBT: With long data,', function () {
    ...
    parallel('Last mile RTT: With long data,', function () {
    ...
    parallel('TOP: With long data,', function () {
    ...
    parallel('TOP Objects: With long data,', function () {
