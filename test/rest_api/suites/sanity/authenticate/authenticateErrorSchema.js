  ...
  describe('Authenticate resource', function () {
    describe('Error Response Data Schema', function () {
      ...
      it('should return data applying `error response` schema when ' +
        'authenticating user with invalid email',
        function (done) {
      ...
      it('should return data applying `error response` schema when ' +
        'authenticating user with invalid password',
        function (done) {
          API.resources.authenticate
            .createOne({
              email: user.email,
      ...
      it('should return data applying `error response` schema when ' +
        'authenticating user with invalid data (missing email)',
        function (done) {
          API.resources.authenticate
            .createOne({
              data: 'user'
      ...
      it('should return data applying `error response` schema when ' +
        'authenticating user with invalid data (missing password)',
        function (done) {
          API.resources.authenticate
            .createOne({
