...
describe('Negative check.', function () {
  ...
  describe('Stats resource.', function () {
    ...
    parallel('GBT: With bogus data,', function () {
    ...
    parallel('Last Mile RTT: With bogus data,', function () {
    ...
    parallel('TOP: With bogus data,', function () {
    ...
    parallel('TOP Objects: With bogus data,', function () {
