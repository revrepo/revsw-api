...
describe('Dashboards resource: pre-requisites', function () {

  // Changing default mocha's timeout (Default is 2 seconds).
  this.timeout(config.get('api.request.maxTimeout'));

  var type = Constants.API.TEST_DATA_TYPES.INVALID;
  var users = [
  ...
  before(function (done) {
    ...
    var getSpecName = function (type, field, value) {
      return 'should return error response when creating `Dashboard` with ' +
        type + ' `' + field + '`: ' + value;
    };
    /**
