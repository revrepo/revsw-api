...
describe('Negative check', function () {
  ...
  describe('Purge resource', function () {
    ...
    it('should return `bad request` response when providing `invalid` purge ID',
      function (done) {
        API.helpers
          .authenticateUser(reseller)
          .then(function () {
    ...
    describe('Create with invalid data', function () {
      ...
      for (var key in purgeSchema) {
        ...
        var ddCase = PurgeDP.DataDrivenHelper
          .generateInvalidData(key, purgeSchema[key]);
