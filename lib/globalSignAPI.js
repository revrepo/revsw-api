...
GSAPI.prototype.urlVerification = function (sslname, callback) {
  var params = {
    Request: {
      OrderRequestHeader: {
        AuthToken: this.auth
...
GSAPI.prototype.dnsVerification = function (sslname, callback) {
  var params = {
    Request: {
      OrderRequestHeader: {
        AuthToken: this.auth
