...
module.exports = {
  ...
  checkUserAccessPermissionToWAFRule: function(request, wafRule) {
    // Rules with “visibility” set to “private” should be visible to “revadmin” role only
    if (wafRule.ryle_type === 'builtin' && wafRule.visibility === 'private') {
    ...
    if (wafRule.ryle_type === 'builtin' && wafRule.visibility === 'public') {
      return true;
    }
  ...
  buildIndexList : function (start_time, end_time, prefix) {
    ...
    // TODO: delete this hack after apply naxsi-[YYYY.MM.DD]
    if(prefix === 'naxsi-'){
      return 'naxsi';
    }
    return list;
