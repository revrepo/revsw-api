    ...
    switch (request.auth.credentials.user_type) {
      case 'user':
        if (request.auth.credentials.permissions) {
          ...
          var accountMatch = request.auth.credentials.companyId.indexOf(sslName.account_id) !== -1;
  ...
  checkUserAccessPermissionToLogShippingJob: function(request, job) {
    ...
    switch (request.auth.credentials.user_type) {
      ...
      if (request.auth.credentials.permissions) {
        ...
        var accountMatch = request.auth.credentials.companyId.indexOf(job.account_id) !== -1;
  ...
  checkUserAccessPermissionToSSLCertificate: function(request, cert) {
    ...
    switch (request.auth.credentials.user_type) {
      ...
      if (request.auth.credentials.permissions) {
          ...
          var accountMatch = request.auth.credentials.companyId.indexOf(cert.account_id) !== -1;
    ...
    if (wafRule.rule_type === 'customer') {
      switch (request.auth.credentials.user_type) {
        ...
        if (request.auth.credentials.permissions) {
          ...
          var accountMatch = request.auth.credentials.companyId.indexOf(wafRule.account_id) !== -1;
    ...
    switch (request.auth.credentials.user_type) {
      case 'user':
        ...
        if (request.auth.credentials.permissions) {
          ...
          var accountMatch = request.auth.credentials.companyId.indexOf(account_id) !== -1;
  ...
  checkUserAccessPermissionToAPIKey : function(request, apiKey){
    ...
    switch (request.auth.credentials.user_type) {
      ...
      if (request.auth.credentials.permissions) {
        ...
        var accountMatch = request.auth.credentials.companyId.indexOf(apiKey.account_id) !== -1;
    ...
    switch (request.auth.credentials.user_type) {
      case 'user':
        if (request.auth.credentials.permissions) {
          ...
          var accountMatch = request.auth.credentials.companyId.indexOf(app.account_id) !== -1;
  ...
  checkUserAccessPermissionToUser: function(request, userObject) {
    ...
    switch (request.auth.credentials.user_type) {
      ...
      if (request.auth.credentials.permissions) {
        ...
        var accountMatch = request.auth.credentials.companyId.indexOf(userObject.companyId[0]) !== -1;
    ...
    switch (request.auth.credentials.user_type) {
      case 'user':
        if (request.auth.credentials.permissions) {
          ...
          var accountMatch = request.auth.credentials.companyId.indexOf(domainObject.account_id) !== -1;
  ...
  checkUserAccessPermissionToDNSZone: function(request, dnsZoneObject) {
    switch (request.auth.credentials.user_type) {
      ...
      if (request.auth.credentials.permissions) {
        ...
        var accountMatch = request.auth.credentials.companyId.indexOf(dnsZoneObject.account_id) !== -1;
