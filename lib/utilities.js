  ...
  checkUserAccessPermissionToUser: function(request, userObject) {
    ...
    switch (request.auth.credentials.user_type) {
      case 'user':
        ...
        // TODO: try to use new code
        // if( userObject.companyId && request.auth.credentials.companyId.indexOf(userObject.companyId[0]) !== -1) {
        //   return false;
        // }
        return true;
      case 'apikey':
        // TODO: try to use new code
        // if(userObject.companyId && this.getAccountID(request).indexOf(userObject.companyId[0]) !== -1) {
        //   console.log(this.getAccountID(request).indexOf(userObject.companyId[0]), userObject.companyId)
        //   return true;
        // }
        // return false;
