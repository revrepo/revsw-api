...

 {
  ...
  config: {
    ...
    validate: {
      ...
      payload: {
        origin_host_header: Joi.string().description('"Host" header value used when accessing the origin server. If not configured then the system is using the name of served domain'),
