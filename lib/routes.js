  ...
  config: {
    ...
    validate: {
      ...
      query: {
        ...
        interval: Joi.number().integer().min(60).description('Reporting interval in seconds'),
        ...
        protocol: Joi.number().integer().description('HTTP protocol port (80/443) value to filter'),
        http_protocol: Joi.string().description('HTTP protocol version value to filter'),
        http_method: Joi.string().description('HTTP method value for to filter'),
  ...
  config: {
    ...
    validate: {
      ...
      query: {
        ...
        protocol: Joi.number().integer().description('HTTP protocol port (80/443) value to filter'),
        http_protocol: Joi.string().description('HTTP protocol version value to filter'),
        http_method: Joi.string().description('HTTP method value to filter'),
        country: Joi.string().length(2).uppercase().regex(/[A-Z]{2}/).description('Two-letters country code of end user location to filter'),
      }
    },
//    response: {
  ...
  config: {
    ...
    validate: {
      ...
      query: {
        ...
        report_type: Joi.string().valid ( 'referer', 'status_code', 'content_type', 'protocol', 'http_protocol', 'http_method', 'content_encoding', 'os', 'device' )
