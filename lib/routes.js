...

 {
  ...
  config: {
    ...
    validate: {
      ...
      query: {
        from_ts: Joi.string().description('Report period start date/timestamp'),
        to_ts: Joi.string().description('Report period end date/timestamp'),
        interval: Joi.string().description('Reporting interval')
      }
    },
//    response: {
//      schema: statsModel
