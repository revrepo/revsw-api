      ...
      return multiCache.wrap(cacheKey, function() {
          ...
          .then(function (ieResp) {
            ...
            .then( function( resp ) {
              ...
              var traff = [];
              if (ieResp.aggregations && ieResp.aggregations.domains.buckets.length) {
                // clean and prep imageEngine query for merge
                ieResp.aggregations.domains.buckets = _.map(ieResp.aggregations.domains.buckets, function (item) {
              ...
              if (resp.aggregations && resp.aggregations.domains.buckets.length) {
                ...
                resp.aggregations.domains.buckets = _.map(resp.aggregations.domains.buckets, function (dom) {
                  return _.assign(dom, _.find(ieResp.aggregations.domains.buckets, { key: dom.key }));
                });
