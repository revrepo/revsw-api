...
var sumAccounts_ = function( accounts, extended ) {
  ...
  accounts.forEach( function( acc ) {
    ...
    //  clunky a bit, but better then sorting-then-filtering
...
module.exports.collectDayReport = function( day, dry ) {
  ...
  return promise.resolve( day )
    ...
    .then( function( responses ) {
      ...
      //  build day totals
      var totals = sumAccounts_( accounts, true/*extended - with samples*/ );
...
//   },
//   domains_usage: [{
//           name: 'delete-me-CDS-QA-name-1456185454814+revsw+net',
//           traffic_per_billing_zone: {
//               'Unknown(TESTSJC20)': {
//                   host: 'TESTSJC20-BP01.REVSW.NET',
//                   code: 'TESTSJC20',
...
//  accountIds can be either ID, an array of IDs or false/nothing for any
...
module.exports.loadReports = function( from, to, accountIds, only_summary, extended, count95p ) {
  ...
  return reports.list( from, to, accountIds )
    .then( function( accounts ) {
      ...
      var s = sumAccounts_( accounts, ( extended || count95p ) );
      if ( count95p ) {
