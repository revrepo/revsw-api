...
var sumAccounts_ = function( records, accountID ) {
  ...
  var res = {
    ...
    domains: { total: 0, deleted: 0, active: 0, ssl_enabled: 0,total_enhanced_web_analytics:0 },
  ...
  for ( var id in lastsForAcc ) {
    ...
    accumulate_( res.total_ssl_names , lastsForAcc[id].total_ssl_names );
...
var genEmptyAccount_ = function( day, created, aid ) {
  return {
    ...
    apps_per_platform: _.defaultsDeep({}, APP_PER_PLATFORMS_DEFAULT_DATA_OBJECT),
    api_keys: { total: 0, inactive: 0, active: 0 },
    domains: { total: 0, deleted: 0, active: 0, ssl_enabled: 0, total_custom_vcl_feature: 0, total_enhanced_web_analytics:0},
    domains_usage: {},
    dns_zones: {total_dns_zones: 0, total_dns_records: 0, total_dns_queries: 0},
    dns_usage: [],
    total_ssl_names: 0
  ...
  return promise.resolve()
     .then(function(){
        ...
        .catch(function(err){
          ...
          logger.error('Error get data from NSONE');
          return promise.resolve([]);
        });
     })
    .then(function(){
