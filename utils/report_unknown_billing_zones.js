...
//  REPORT about sites without assigned billing zone
//  ----------------------------------------------------------------------------------------------//
'use strict';

var promise = require('bluebird');
var usageReportAboutSitesWithoutAssignedBillingZone = promise.promisify(require('../lib/usageReport.js').reportAboutSitesWithoutAssignedBillingZone);
...
var showHelp = function() {
  console.log('\n  Report about sites without assigned billing zone  - a tool to collect usage data and send report to admin');
  console.log('  Usage:');
  console.log('    --date :');
...
promise.resolve()
  .then(function() {
    log_('usageReport:AboutSitesWithoutAssignedBillingZone:call');
    return usageReportAboutSitesWithoutAssignedBillingZone({
      date: (conf.date || 'now'),
      dryRun: conf.dry,
  ...
  .then(function sucess(data) {
    ...
    console.log('usageReport:AboutSitesWithoutAssignedBillingZone:done\n');
  })
  .catch(function(err) {
    console.log(err);
  })
